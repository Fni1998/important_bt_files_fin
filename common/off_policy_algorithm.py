...
class OffPolicyAlgorithm(BaseAlgorithm):
    ...
    def __init__(
        ...
        verbose: int = 0,
        device: Union[th.device, str] = "auto", #normally auto or cuda
    ...
    def _setup_model(self) -> None:
        ...
        if self.replay_buffer_class is None:
            ...
            self.replay_buffer = HerReplayBuffer(
                ...
                self.buffer_size,
                self.device,
                goal_selection_strategy=HerReplayBuffer.goal_selection_strategy, #TODO ?
    ...
    def learn(
        ...
        reset_num_timesteps: bool = True, #hier vllt false?
    ) -> "OffPolicyAlgorithm":
    ...
    def collect_rollouts(
        ...
        while should_collect_more_steps(train_freq, num_collected_steps, num_collected_episodes):
            ...
            while not done:
                ...
                #euclidean distance
                MSVE = np.linalg.norm(new_obs["desired_goal"] - new_obs["achieved_goal"])
                # Zstzl Daten in infos geschrieben
                infos[0].update({"Action": action}) #zugehoerige Aktion
                infos[0].update({"Avg Difference": MSVE}) #zusammengerechnetes Array
                self.replay_buffer.metrics[self.replay_buffer.n_episodes_stored*50 + self.replay_buffer.pos] = MSVE
